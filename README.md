...
> **З повною версією керівництва користувача можлиово ознайомитися у [MANUAL.md](src/markdown/MANUAL.md)**
...
Зі списком авторів можливо ознайомитися у файлі [AUTHORS.md](/src/markdown/AUTHORS.md)
