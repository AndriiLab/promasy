...
public class EntityComboBox<T extends IEntity> extends PJComboBox<T> {
    ...
    /**
     * Function sets PJComboBox with persistence with special parameters.
     ...
     * @param emptyModel   com.github.andriilab.promasy.domain.model with default persistence which implements {@link IEntity} interface
