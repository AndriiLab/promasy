...
import com.github.andriilab.promasy.gui.controller.ReportsGenerator;
import com.github.andriilab.promasy.persistence.models.CpvAmountReportModel;
...
public class CpvAmountDialog extends JDialog {
    ...
    public void setTableData(List<CpvAmount> db) {
        List<CpvAmountReportModel> list = db.stream().map(CpvAmount::generateCpvAmountReportModel).collect(Collectors.toList());
