...
import com.github.andriilab.promasy.app.view.MainFrameListener;
...
import com.github.andriilab.promasy.app.commons.SystemCommands;
...
public class Controller {
    ...
    private void initMainFrame() {
        ...
        mainFrame.setAmUnitsDialogListener(new AmUnitsDialogListener() {
            @Override
            public void persistModelEventOccurred(ICommand<AmountUnit> command) {
                handleCommand(command);
        ...
        mainFrame.setProducerDialogListener(new ProducerDialogListener() {
            @Override
            public void persistModelEventOccurred(ICommand<Producer>  command) {
                handleCommand(command);
        ...
        mainFrame.setSupplierDialogListener(new SupplierDialogListener() {
            @Override
            public void persistModelEventOccurred(ICommand<Supplier> command) {
                handleCommand(command);
        ...
        mainFrame.setReasonsDialogListener(new ReasonsDialogListener() {
            @Override
            public void persistModelEventOccurred(ICommand<ReasonForSupplierChoice> command) {
                handleCommand(command);
