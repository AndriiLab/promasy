...
import com.github.andriilab.promasy.app.commons.*;
...
public class CreateBidPanel extends JPanel {
    ...
    CreateBidPanel(MainFrame parent) {
        ...
        okButton.addActionListener(e -> {
                    if (checkFields()) {
                        ...
                        ICommand<Bid> command = createdBidModel.getModelId() != 0L ? new UpdateCommand<>(createdBidModel) : new CreateCommand<>(createdBidModel);
    ...
    private boolean checkFields() {
        ...
        if (createdBidModel.equals(EmptyModel.BID)) {
            ...
            statusModel.setCreatedDate(ServerRepository.getServerTimestamp());
            statusModel.setCreatedEmployee(LoginData.getInstance());
