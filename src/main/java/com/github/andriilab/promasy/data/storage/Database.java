...
import com.github.andriilab.promasy.data.queries.*;

public class Database {
    public static final DBConnector CONNECTOR = DBConnector.INSTANCE;
	public static final CPVQueries CPV = new CPVQueries();
    public static final AmountUnitQueries AMOUNTUNITS = new AmountUnitQueries();
