package com.github.andriilab.promasy.gui.supplier;
...
import com.github.andriilab.promasy.gui.components.PJOptionPane;
...
public class SupplierDialog extends AbstractCEDDialog<SupplierModel, SupplierDialogListener> {
    ...
    protected SupplierModel createOrUpdate(MainFrame parent) {
        ...
        if (!newName.isEmpty() && isSuplDataValid() && listener != null) {
            //if box is not empty by default set to create new com.github.andriilab.promasy.model
            int choice = JOptionPane.NO_OPTION;
            //if not a new com.github.andriilab.promasy.model was selected - show dialog to confirm edit
            if (!privateModel.equals(emptyModel)) {
                choice = PJOptionPane.renameEntry(parent, oldName, newName);
            }
            //it edit confirmed - updating com.github.andriilab.promasy.model
            if (choice == JOptionPane.YES_OPTION) {
                ...
                //if edit is not confirmed or com.github.andriilab.promasy.model does not exist - creating new com.github.andriilab.promasy.model with specified name
