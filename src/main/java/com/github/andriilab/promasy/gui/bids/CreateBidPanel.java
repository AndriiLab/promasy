...
import com.github.andriilab.promasy.gui.Utils;
...
import com.github.andriilab.promasy.gui.components.CEDButtons;
...
public class CreateBidPanel extends JPanel {
    ...
    private final PJComboBox<ProducerModel> producerBox;
    private final PJComboBox<SupplierModel> supplierBox;
    private final PJComboBox<AmountUnitsModel> amUnitsBox;
    private final PJComboBox<ReasonForSupplierChoiceModel> reasonForSupplierChoiceBox;
